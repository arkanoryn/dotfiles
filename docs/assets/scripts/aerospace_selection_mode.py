...
no_mods_replacements = {
    "L0:": "'Aerospace | Selection Mode | No Mods':",
    # Default Graphite
    ## First Row - Left
    ...
    "GUI_F": f"{{ {utils.ACTION_SELECT}, h: '5' }}",
    "ALT_O": f"{{ {utils.ACTION_SELECT}, h: '6' }}",
    "CTL_U": f"{{ {utils.ACTION_SELECT}, h: '7' }}",
    "GRAPHITE_J": f"{{ {utils.ACTION_SELECT}, h: '8' }}",
    ## 2nd row - Right
    "GRAPHITE_Y": utils.NO_ACTION,
    "L1_H": f"{{ {utils.ACTION_SELECT}, h: '1' }}",
    "L2_A": f"{{ {utils.ACTION_SELECT}, h: '2' }}",
    "L3_E": f"{{ {utils.ACTION_SELECT}, h: '3' }}",
    "L4_I": f"{{ {utils.ACTION_SELECT}, h: '4' }}",
    ## 3rd Row - Right
...
meh_mods_replacements = {
    "L0:": "'Aerospace | Selection Mode | Meh Mods':",
    # Default Graphite
    ## First Row - Left
    "GRAPHITE_B": utils.NO_ACTION,
    "CTL_L": utils.NO_ACTION,
...
alt_mods_replacements = {
    "L0:": "'Aerospace | Selection Mode | ALT Mod':",
    # Default Graphite
    ## First Row - Left
    "GRAPHITE_B": utils.NO_ACTION,
    "CTL_L": utils.NO_ACTION,
    ...
    ## 2nd row - Right
    "GRAPHITE_Y": utils.NO_ACTION,
    "L1_H": f"{{ {utils.ACTION_MOVE}, h: 'left' }}",
    "L2_A": f"{{ {utils.ACTION_MOVE}, h: 'down' }}",
    "L3_E": f"{{ {utils.ACTION_MOVE}, h: 'up' }}",
    "L4_I": f"{{ {utils.ACTION_MOVE}, h: 'right' }}",
    ## 3rd Row - Right
    "GRAPHITE_K": utils.NO_ACTION,
    "GRAPHITE_P": utils.NO_ACTION,
    "DOT_EXLM": utils.NO_ACTION,
